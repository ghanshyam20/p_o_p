...
print("welcome to Tresure Insaland")
...
if choice1=="left":
    ...
    choice2=input('You come to a lake.There is an island in the middle of the ' \
    'lake Type "wait" to wait for a boat.Type "swim" to swim accross.:').lower()
